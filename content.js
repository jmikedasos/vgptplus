const translations = {
    id: {
        ...
        support: {
            ...
            items: [
                { icon: "cube-outline", label: "Verify Bot", value: "@vgptplusbot", link: "https://t.me/vgptplusbot", sub: "use /vgpt" },

                { icon: "people-outline", label: "Group", value: "Join Community", link: "https://t.me/autogptverifygroup", sub: "Official Group" },
                { icon: "radio-outline", label: "Channel", value: "Subscribe", link: "https://t.me/autogptverify", sub: "Announcements" }
            ]
        },
        hero: {
    ...
    en: {
        ...
        support: {
            ...
            items: [
                { icon: "cube-outline", label: "Verify Bot", value: "@vgptplusbot", link: "https://t.me/vgptplusbot", sub: "use /vgpt" },
                { icon: "person-outline", label: "Admin", value: "@namikui", link: "https://t.me/namikui", sub: "Support" },
                { icon: "people-outline", label: "Group", value: "Join Community", link: "https://t.me/autogptverifygroup", sub: "Official Group" },
                { icon: "radio-outline", label: "Channel", value: "Subscribe", link: "https://t.me/autogptverify", sub: "Announcements" }
            ]
        },
